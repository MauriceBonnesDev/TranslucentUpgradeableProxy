...
export interface ImplementationV1Interface extends Interface {
  getFunction(nameOrSignature: "sum" | "totalValue"): FunctionFragment;
...
export interface ImplementationV1 extends BaseContract {
  connect(runner?: ContractRunner | null): ImplementationV1;
  waitForDeployment(): Promise<this>;

  interface: ImplementationV1Interface;
